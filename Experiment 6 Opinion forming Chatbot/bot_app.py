...
from tkinter import *
from sim_test_senti import get_response, bot_name
...
class ChatBotApplication:
    ...
    def _setup_main_window(self):
        ...
        bottomlabel = Label(self.window, bg=BG_GRAY, height=80)
        ...
        send_button = Button(bottomlabel, text="Send", font=FONT_BOLD, width=20, bg=BG_GRAY,
